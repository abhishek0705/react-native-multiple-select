    ...
    return actualSelectedItems.map(singleSelectedItem => {
      ...
      return (
        ...
        >
          ...
          >
            <Image style={{ height: 30, width: 30, resizeMode: 'contain', marginRight: 20 }} source={this.props.crossIcon} />
          </TouchableOpacity>
        </View>
      );
    });
        ...
        <View>
          <View style={{ flexDirection: 'row', alignItems: 'center' }}>
            ...
            {this._itemSelected(item) ? (
              <Image style={{ height: 30, width: 30, resizeMode: 'contain', marginRight: 20 }} source={this.props.check} />
            ) : null}
          </View>
        </View>
      </TouchableOpacity>
            ...
            >
              ...
              {hideSubmitButton && (
                <TouchableOpacity onPress={this._submitSelection}>
                    <Text style={[{ color: "#0b3060", transform: [{ rotate: "90deg" }] }]}>{">"}</Text>
                </TouchableOpacity>
              )}
              {!hideDropdown && (
                  <Text style={[{ color: "#0b3060" }]}>{"<"}</Text>
              ...
              >
                <TouchableWithoutFeedback onPress={this._toggleSelector}>
                  ...
                  >
                    ...
                    <Text style={[!hideSubmitButton ? { color: "#0b3060", transform: [{ rotate: "90deg" }] } : { color: "#0b3060" }]}>{">"}</Text>
                  </View>
                </TouchableWithoutFeedback>
              </View>
            </View>

...
export default class MultiSelect extends Component {
    ...
    return actualSelectedItems.map(singleSelectedItem => {
      ...
      return (
        ...
        >
          ...
          >
            <Image style={{ height: 20, width: 20, resizeMode: 'contain', marginRight: 10 }} source={this.props.crossIcon} />
          </TouchableOpacity>
        </View>
      );
    });
        ...
        <View>
          <View style={{ flexDirection: 'row', alignItems: 'center' }}>
            ...
            {this._itemSelected(item) ? (
              <Image style={{ height: 20, width: 20, resizeMode: 'contain', marginRight: 20 }} source={this.props.check} />
            ) : null}
          </View>
        </View>
      </TouchableOpacity>
  ...
  _renderItems = () => {
    ...
    if (renderItems.length) {
      ...
      searchTermMatch = renderItems.filter(item => item.label === searchTerm)
        .length;
    } else if (!canAddItems) {
      itemList = (
        <View style={{ flexDirection: 'row', alignItems: 'center' }}>
            ...
            >
              ...
              {hideSubmitButton && (
                <TouchableOpacity onPress={this._submitSelection}>
                    <Text style={[{ color: "gray", transform: [{ rotate: "90deg" }] }]}>{">"}</Text>
                </TouchableOpacity>
              )}
              {!hideDropdown && (
                <TouchableOpacity onPress={this._toggleSelector}>
                  <Image style={{ height: 20, width: 20, resizeMode: 'contain', marginRight: 3 }} source={this.props.crossIcon} />
                </TouchableOpacity>
              ...
              >
                <TouchableWithoutFeedback onPress={this._toggleSelector}>
                  ...
                  >
                    ...
                    <Image style={{ height: 10, width: 10, resizeMode: 'contain', marginRight: 3 }} source={this.props.dropDownImage} />
                    {/* <Text style={[!hideSubmitButton ? { color: "gray", transform: [{ rotate: "90deg" }] } : { color: "gray" }]}>{">"}</Text> */}
                  </View>
                </TouchableWithoutFeedback>
              </View>
            </View>
